...
import { TableFilter, TableCard, Table, TableHead, TableRow, TableBody, TableCell, TableEmpty, TableHeader } from "@/components/ui/table";
...
export default function Index() {
    ...
    return (
        <>
            ...
            <Header title="AksesGroup" subtitle="Halaman ini digunakan untuk mengelola data hak akses group pengguna">
                                        ...
                                        <TableRow key={index}>
                                            ...
                                            <TableCell>
                                                {role.name == 'super-admin' ?
                                                    ...
                                                    :
                                                    <div className="flex flex-wrap gap-1">{role.permissions.map((permission, i) => (
