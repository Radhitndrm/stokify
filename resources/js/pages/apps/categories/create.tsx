    ...
    return (
        <>
            ...
            <div className="w-full">
                <Header title='Tambah Data Kategori' subtitle='Halaman ini digunakan untuk menambah data kategori' />
                <div className="p-6">
                    <Card>
                        <CardHeader>
                            <CardTitle>Tambah Kategori</CardTitle>
                            <CardDescription>Form ini digunakan untuk menambakan data kategori</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="w-full">
                                <form onSubmit={storeData}>
                                    ...
                                    <div className="mb-4 flex flex-col gap-2">
                                        ...
                                        <Textarea value={data.description} onChange={(e) => setData('description', e.target.value)} placeholder='Masukan deskripsi kategori' />
